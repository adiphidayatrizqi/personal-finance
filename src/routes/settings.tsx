...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      { title: "Settings — Savvr" },
      { name: "description", content: "Settings page on Savvr personal finance dashboard." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <div className="px-6 lg:px-10 py-12 max-w-[1400px] mx-auto">
      <h1 className="text-3xl font-semibold tracking-tight text-foreground capitalize">settings</h1>
