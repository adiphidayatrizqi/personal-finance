...
export const Route = createFileRoute("/portfolio")({
  head: () => ({
    meta: [
      { title: "Portfolio — Savvr" },
      { name: "description", content: "Portfolio page on Savvr personal finance dashboard." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <div className="px-6 lg:px-10 py-12 max-w-[1400px] mx-auto">
      <h1 className="text-3xl font-semibold tracking-tight text-foreground capitalize">portfolio</h1>
